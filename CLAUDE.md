...
schema.rs     — parse_tline() → TLine, parse_schema_preamble(),
                base_schema() (sch_13006), standard_schema() (dialect B)
entity.rs     — parse_entities_opt(): type_id → inline schema → entity_idx → fields
                (parse_entities() = dialect A shorthand)
